                ...
                <div class="row g-4">
                    <div class="col-lg-12">
                        <div class="row g-4 py-3 align-items-stretch">
                            <div class="col-xl-3">
                                <div class="input-group w-100 mx-auto d-flex h-100">
                                    <input type="search" class="form-control p-3 h-100" placeholder="keywords" aria-describedby="search-icon-1">
                                    <span id="search-icon-1" class="input-group-text p-3 h-100"><i class="fa fa-search"></i></span>
                                </div>
                            </div>

                            <div class="col-xl-3 ms-auto">
                                <div class="bg-light ps-3 py-3 rounded d-flex justify-content-between h-100">
                            ...
                            <div class="col-2 d-flex align-items-center justify-content-end">
                                <button class="btn btn-primary px-4 h-100 d-flex align-items-center w-100 justify-content-center">
                            ...
                            <div class="col-lg-12">
                                <div class="row g-4 justify-content-center" id="listProduct">
                                    <div class="col-md-6 col-lg-6 col-xl-4" >
                                        <a href="/products?id=123" class="text-decoration-none text-dark">
    ...
    <script type="module">
        ...
        var getProduct = (dataProducts) => {
            ...
            dataProducts.forEach((p, idx) => {
                ...
                col.innerHTML = `
                    <a href="/products?id=${p.id}" class="text-decoration-none text-dark">
        ...
        await apiFetch("{{$productURL}}","{}","GET",@json($token)).then(result => {
            console.log(result)
